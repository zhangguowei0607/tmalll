// 收藏图标
$('.icon').click(function(){
    $('.icon_box').css({"color":"red"});
    $('.icon').css({"color":"red"});
})
// 支付方式
$('.zoom_btn2').click(function(){
    $('.zoom_btn2_box').css({"display":"block"});
    $('.zoom_btn2').mouseleave(function(){
        $('.zoom_btn2_box').css({"display":"none"});
    })
})
// 地址
$('.address').click(function(){
    ...
    $('.address_province').click(function(){
        $('.address_province').css({"background":"white"});
        $('.address_city').css({"background":"#f2f2f2"});
        $('.address_provinceS').css({"display":"block"});
        $('.address_cityS').css({"display":"none"});
    })
    // 市
    $('.address_city').click(function(){
        $('.address_city').css({"background":"white"});
        $('.address_province').css({"background":"#f2f2f2"});
        $('.address_provinceS').css({"display":"none"});
        $('.address_cityS').css({"display":"block"});
    })
    // 遍历所有省
...
$('.zoom_btn1').focus(function(){
    ...
    $('.zoom_btn1').blur(function(){
        ...
        $('.zoom_btn1').val(num);
        let str1 = `￥${84.00*num}x3`;
        $('.huaBei_much1').html(str1);
        let str2 = `￥${43.00*num}x6`;
        $('.huaBei_much2').html(str2);
        let str3 = `￥${22.00*num}x12`;
...
$('.extend_imgK1').click(function(){
    $('.extend_imgK1').css({"display":"none"});
    $('.extend_imgG1').css({"display":"block"});
    $('.extend_menu1').css({"display":"block"});

    $('.extend_imgG1').click(function(){
        $('.extend_imgG1').css({"display":"none"});
        $('.extend_imgK1').css({"display":"block"});
        $('.extend_menu1').css({"display":"none"});
    })
})
$('.extend_imgK2').click(function(){
    $('.extend_imgK2').css({"display":"none"});
    $('.extend_imgG2').css({"display":"block"});
    $('.extend_menu2').css({"display":"block"});

    $('.extend_imgG2').click(function(){
        $('.extend_imgG2').css({"display":"none"});
        $('.extend_imgK2').css({"display":"block"});
        $('.extend_menu2').css({"display":"none"});
    })
})
$('.extend_imgK3').click(function(){
    $('.extend_imgK3').css({"display":"none"});
    $('.extend_imgG3').css({"display":"block"});
    $('.extend_menu3').css({"display":"block"});

    $('.extend_imgG3').click(function(){
        $('.extend_imgG3').css({"display":"none"});
        $('.extend_imgK3').css({"display":"block"});
        $('.extend_menu3').css({"display":"none"});
    })
})
$('.extend_imgK4').click(function(){
    $('.extend_imgK4').css({"display":"none"});
    $('.extend_imgG4').css({"display":"block"});
    $('.extend_menu4').css({"display":"block"});

    $('.extend_imgG4').click(function(){
        $('.extend_imgG4').css({"display":"none"});
        $('.extend_imgK4').css({"display":"block"});
        $('.extend_menu4').css({"display":"none"});
    })
})
$('.extend_imgK5').click(function(){
    $('.extend_imgK5').css({"display":"none"});
    $('.extend_imgG5').css({"display":"block"});
    $('.extend_menu5').css({"display":"block"});

    $('.extend_imgG5').click(function(){
        $('.extend_imgG5').css({"display":"none"});
        $('.extend_imgK5').css({"display":"block"});
        $('.extend_menu5').css({"display":"none"});
    })
})
$('.extend_imgK6').click(function(){
    $('.extend_imgK6').css({"display":"none"});
    $('.extend_imgG6').css({"display":"block"});
    $('.extend_menu6').css({"display":"block"});

    $('.extend_imgG6').click(function(){
        $('.extend_imgG6').css({"display":"none"});
        $('.extend_imgK6').css({"display":"block"});
        $('.extend_menu6').css({"display":"none"});
    })
})
$('.extend_imgK7').click(function(){
    $('.extend_imgK7').css({"display":"none"});
    $('.extend_imgG7').css({"display":"block"});
    $('.extend_menu7').css({"display":"block"});

    $('.extend_imgG7').click(function(){
        $('.extend_imgG7').css({"display":"none"});
        $('.extend_imgK7').css({"display":"block"});
        $('.extend_menu7').css({"display":"none"});
    })
})
$('.extend_imgK8').click(function(){
    $('.extend_imgK8').css({"display":"none"});
    $('.extend_imgG8').css({"display":"block"});
    $('.extend_menu8').css({"display":"block"});

    $('.extend_imgG8').click(function(){
        $('.extend_imgG8').css({"display":"none"});
        $('.extend_imgK8').css({"display":"block"});
        $('.extend_menu8').css({"display":"none"});
    })
})
...
$('.main_l_d_boxL').click(function(){
    $('.main_l_d_boxL').css({"background":"white"});
    $('.main_l_d_boxR').css({"background":"#e5e5e5"});
    $('.main_l_d_box ol').css({"display":"none"});
    $('.main_l_d_box ul').css({"display":"block"});
})
$('.main_l_d_boxR').click(function(){
    $('.main_l_d_boxL').css({"background":"#e5e5e5"});
    $('.main_l_d_boxR').css({"background":"white"});
    $('.main_l_d_box ol').css({"display":"block"});
    $('.main_l_d_box ul').css({"display":"none"});
})
