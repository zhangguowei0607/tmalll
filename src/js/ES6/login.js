$('.main .login .login_Ewm .login_img').click(function(){
    $('.main .login .login_Ewm').css({"display" : "none"});
    $('.main .login .login_Act').css({"display" : "block"});
})
$('.main .login .login_Act .login_img').click(function(){
    $('.main .login .login_Act').css({"display" : "none"});
    $('.main .login .login_Ewm').css({"display" : "block"});
})
...
// 实现cookie交互
// 获取页面元素
let oName = $('.login_btn1')[0];
let oPwd = $('.login_btn2')[0];
// 登录按钮
let oBtn = $('.login_Act button')[0];
